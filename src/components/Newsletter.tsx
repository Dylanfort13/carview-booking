...
export default function Newsletter() {
  ...
  const title = newsletter?.title || "Stay Updated"
  const subheadline = newsletter?.subheadline || "Join Our Mailing List"
  const description = newsletter?.description || "Receive emails about cars, city views, and what we're up to."
  const confirmation = newsletter?.confirmation || "You're on the list!"
